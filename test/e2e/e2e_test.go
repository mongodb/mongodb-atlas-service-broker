...
func TestCatalog(t *testing.T) {
	...
	classes, _ := svcatClient.ServicecatalogV1beta1().ClusterServiceClasses().List(metav1.ListOptions{})
	...
	err := testutil.Poll(10, func() (bool, error) {
		...
		classes, err := svcatClient.ServicecatalogV1beta1().ClusterServiceClasses().List(metav1.ListOptions{})
		if err != nil {
			return false, err
		}
	...
	plans, _ := svcatClient.ServicecatalogV1beta1().ClusterServicePlans().List(metav1.ListOptions{})
